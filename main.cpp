...
//int big_story(){
//	string hi;
//	cout << "In a faraway kingdom, there was an enchanted forest where magical creatures lived. The forest was guarded by a wise old <animal> named <name>. One day, a young adventurer named <name2> decided to explore the forest. Armed with a <adjective> <noun> and a map given by a mysterious <noun>, <name2> ventured into the forest. The trees were <adjective>, and the air was filled with the scent of <food>. As <name2> walked deeper, they encountered a <adjective> fairy named <name3> who needed help finding a lost <noun>. Together, they navigated through the <adjective> forest, facing challenges like crossing a <adjective> river and solving a riddle from a <adjective> troll. \n\nAfter hours of searching, they found the lost <noun> in a cave guarded by a <adjective> dragon. Using their <noun>, <name2> managed to distract the dragon while <name3> retrieved the <noun>. Grateful, the fairy rewarded <name2> with a <adjective> gem that granted one wish. <name2> wished for the forest to always be protected. The wish came true, and the enchanted forest remained safe forever. <name2> returned to their village as a hero, and the story of their adventure was told for generations.";
//}
//
//int mid_story(){
//	string hi;
//	cout << "Once upon a time, in the land of <place>, there lived a brave explorer named <name>. <name> loved to discover new places and find hidden treasures. One day, they found a mysterious map that led to a <adjective> treasure. With their trusty <noun> in hand, they set off on their journey. Along the way, they encountered a <adjective> <animal> that tried to steal their map. Using their <noun>, <name> managed to scare off the <animal>. After days of traveling through <adjective> forests and crossing <adjective> rivers, <name> finally found the treasure chest. Inside, there were <plural noun> and a <adjective> <noun>. <name> returned home as a hero, and the people of <place> celebrated their <adjective> adventure.";
//}
//
//int small_story(){
...
//	getline(cin, verb);
//	
//	cout << "One sunny day, " << name << " decided to visit the park. They brought their favorite "<< noun << " and a delicious " << food << ". As they walked, they saw a "<< adj << " " << animal <<" playing with a " << noun << ". Suddenly, it started to "<< verb << ", making everyone laugh. It was a " << adj << " day that " << name << " would never forget.";
//}
//
//int main() {
//	int ch;
